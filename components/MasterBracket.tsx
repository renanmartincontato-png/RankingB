...
const MatchCard: React.FC<MatchCardProps> = ({ match, getPlayerName, getPlayerRank, onClick }) => {
    ...
    const isClickable = match.player1Id !== null && match.player2Id !== null;
...
const RoundColumn: React.FC<RoundColumnProps> = ({ title, matches, getPlayerName, getPlayerRank, onMatchClick }) => {
    return (
...
export const MasterBracket: React.FC<MasterBracketProps> = ({ players, contenders, bracketData, onMatchClick }) => {
    ...
    return (
        <div className="bg-slate-800 rounded-lg shadow-lg p-4 lg:p-6">
            ...
            <div className="flex space-x-6 overflow-x-auto p-4 custom-scrollbar">
                <RoundColumn title="Oitavas" matches={rounds.R16} getPlayerName={getPlayerName} getPlayerRank={getPlayerRank} onMatchClick={onMatchClick} />
                <RoundColumn title="Quartas" matches={rounds.QF} getPlayerName={getPlayerName} getPlayerRank={getPlayerRank} onMatchClick={onMatchClick} />
                <RoundColumn title="Semifinal" matches={rounds.SF} getPlayerName={getPlayerName} getPlayerRank={getPlayerRank} onMatchClick={onMatchClick} />
                <RoundColumn title="Final" matches={rounds.F} getPlayerName={getPlayerName} getPlayerRank={getPlayerRank} onMatchClick={onMatchClick} />
            </div>
            <style>{`
