...
export const GroupCard: React.FC<GroupCardProps> = ({ group, players, matches, onMatchClick }) => {
        ...
        <ul className="space-y-2">
          {matches.map(match => (
            <li 
              ...
              className="p-2 rounded-md bg-slate-700 hover:bg-slate-600 cursor-pointer transition"
            >
